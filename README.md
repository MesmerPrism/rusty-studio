...
- render a minimal Makepad desktop shell from that descriptor.
...
request. The desktop shell is a read-only descriptor or artifact-manifest
consumer; it does not own runtime command/session authority, launch, or
evidence collection.
